...
import com.example.clientapp.Data.Repository.TicketRepositoryImpl
...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideTicketRepository(apiTicketService: ApiTicketService): TicketRepository {
        return TicketRepositoryImpl(apiTicketService)
    }
}