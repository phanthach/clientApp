...
class PaymentCanceledAdapter(private val mList: MutableList<Payment>, private val itemListener: ItemListener): RecyclerView.Adapter<PaymentCanceledAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding:ItemHistoryBinding, private val itemListener: ItemListener) : RecyclerView.ViewHolder(binding.root){
        fun bind(item: Payment, position: Int){
            ...
            if(item.cancelTime==null){
                ...
                binding.tvCancleTimeTitle.text = "Hủy lúc: "
